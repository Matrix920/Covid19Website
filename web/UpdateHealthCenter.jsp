...
<head>
    ...
    <!-- Site Metas -->
    <title>معلومات المركز الصحي</title>
    ...
    <%
        ...
        */
        ...
        if(health_center_id!=null){
            h=HealthCenterApi.get(Integer.parseInt(health_center_id));
        }
        ...
        if(governorate_id!=null && health_center_name!=null && health_center_id!=null){            
            
            HealthCenterApi.update(new HealthCenter(Integer.parseInt(health_center_id), health_center_name, Integer.parseInt(governorate_id)));
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="banner_title">
                        <h3>تعديل معلومات المركز الصحي</h3>
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <div class="full">
                        <form class="contact_form_inner" action="" method="post">
                            <fieldset>
                                ...
                                <div class="field">
                                    <input type="text" name="health_center_id" value="<%= h.health_center_id %>" readonly />
                                </div>
                                <div class="field">
                                    <input type="text" name="health_center_name" value="<%= h.health_center_name%>" placeholder="Username" />
                                </div>
                                <div class="field">
