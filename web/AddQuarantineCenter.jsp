 ...
 <%@page import="api.UserApi" %>
    ...
    <%
        ...
        */
        ...
        if(governorate_id!=null && quarantine_center_name!=null){            
            
            QuarantineCenterApi.add(new QuarantineCenter(0, quarantine_center_name, Integer.parseInt(governorate_id)));
                ...
                <div class="col-lg-6 col-sm-12 offset-lg-3">
                    <div class="full">
                        <form class="contact_form_inner" action="" method="post">
                            <fieldset>
                                <div class="field">
                                    <input type="text" name="quarantine_center_name" placeholder="اسم المركز" />
                                </div>
                                <div class="field">
