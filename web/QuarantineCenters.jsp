            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="banner_title">
                        <h3>خريطة تظهر توزع مراكز الحجر الصحي في سوريا</h3>
                    </div>
                </div>
            </div>
        </div>
                     ...
                     <div id="map"></div>
                         <script>
                             ...
                             function InitializeMap() {
                                 ...
                                 var ltlng = [];
                                 var contents = [
                                     " الحسكة <br/>الهيئة العامة لمشفى القامشلي ",
                                     "فرع ديرالزور <br/>الهيئة العامة لمشفى الأسد <hr/>مشفى الفرات",
                                     " حلب <br/> مشفى حلب الجامعي <hr/>مشفى زاهي أزرق ",
                                     "فرع اللاذقية <br/>الهيئةالعامة لمشفى الحفة الوطني",
                                     " حماة<br/>الهيئة العامة لمشفى حماة الوطني <hr/>الهيئة العامة لمشفى الأسد الطبي",
                                     " طرطوس<br/>معسكر الطلائع",
                                     " حمص <br/> مشفى ابن الوليد",
                                     " دمشق<br/>مشفى الزبداني الوطني",
                                     " ريف دمشق<br/>مشفى الزبداني الوطني",
                                     " درعا<br/>مشقى إزرع",
                                     "فرع السويداء<br/> مشفى الشهيد زيد الشريطي ",
                                 "القنيطرة<br/>مشفى الشهيد ممدوح أباظة"]
                                 //الحسكة
