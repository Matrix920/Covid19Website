    ...
    <%
        ...
        */
        ...
        if(quarantine_center_id!=null){
            h=QuarantineCenterApi.get(Integer.parseInt(quarantine_center_id));
        }
        
        List<Governorate>governorates=GovernorateApi.get_all();
             
        String governorate_id=request.getParameter(Governorate.ID);
        String quarantine_center_name=request.getParameter(QuarantineCenter.NAME);

        if(governorate_id!=null && quarantine_center_name!=null && quarantine_center_id!=null){            
            
            QuarantineCenterApi.update(new QuarantineCenter(Integer.parseInt(quarantine_center_id), quarantine_center_name, Integer.parseInt(governorate_id)));
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="banner_title">
                        <h3>تعديل معلومات مركز الحجر الصحي</h3>
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <div class="full">
                        <form class="contact_form_inner" action="" method="post">
                            <fieldset>
                                ...
                                <div class="field">
                                    <input type="text" name="quarantine_center_id" value="<%= h.quarantine_center_id %>" readonly />
                                </div>
                                <div class="field">
                                    <input type="text" name="quarantine_center_name" value="<%= h.quarantine_center_name %>" placeholder="اسم المركز" />
                                </div>
                                <div class="field">
                                     <select name="governorate_id" style="width:100%">
                                    <% for(Governorate g : governorates){%>
                                    <option value="<%=g.governorate_id%>" <%= g.governorate_id==h.governorate_id?"selected":"" %>><%=g.governorate_name%></option>
                                    <%}%>
                                    </select>
                                </div>
