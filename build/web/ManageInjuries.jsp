...
<%
        ...
        */
        ...
        List<Sick> suspects=SickApi.get_injuries();
...
<body id="home" data-spy="scroll" data-target="#navbar-wd" data-offset="98">
 ...
 <!-- Start Banner -->
            ...
            <div class="row">
                <div class="col-md-12 col-sm-6 col-xs-12">
                    <div class="full services_blog">
                        <form action="MoveToHealthCenter.jsp" method="post">
                     <table id="customers">
  <tr>
    <th>الرقم</th>
    <th>الاسم</th>
  ...
  <tr>
      ...
      <td><%= s.nationality_number %></td>
      <td><%= s.state.state_name %></td>
      <td><a href="UpdateSick.jsp?sick_id=<%= s.sick_id %>">تعديل حالة المصاب</a></td>
  </tr>
  <%}%>
</table>
                        </form>
