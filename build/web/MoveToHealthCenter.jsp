<%@page import="entity.SickHealthCenter"%>
<%@page import="api.SickHealthCenterApi"%>
...
<head>
    ...
    <!-- Site Metas -->
    <title>نقل إلى المركز الصحي</title>
...
<%
        ...
        */
        ...
        if(health_center_id!=null){
            SickApi.update_state(Integer.parseInt(s_sick_id), State.INJURED);
            SickHealthCenterApi.add(new SickHealthCenter(0, Integer.parseInt(s_sick_id), Integer.parseInt(health_center_id)));
...
<body id="home" data-spy="scroll" data-target="#navbar-wd" data-offset="98">
 ...
 <!-- Start Banner -->
  ...
  <tr>
      <td><input type="text" name="sick_id" value="<%=sick.sick_id%>" readonly></td>
      ...
      <td><select name="health_center_id" style="width: 100%">
              <% List<HealthCenter> centers=HealthCenterApi.get_all();
              for(HealthCenter h:centers){
                  %>
                  <option value="<%=h.health_center_id%>"><%out.print(h.health_center_name+" ( "+h.governorate.governorate_name+" )");%></option>
                  <%
              }%>
          </select></td>
