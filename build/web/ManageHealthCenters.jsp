...
<head>
    ...
    <!-- Site Metas -->
    <title>إدراة المراكز الصحية</title>
...
<body id="home" data-spy="scroll" data-target="#navbar-wd" data-offset="98">
 ...
 <!-- Start Banner -->
  ...
  <% for(HealthCenter c : centers){%>
  <tr>
      <td><%= c.health_center_id %></td>
      <td>
          <%=c.health_center_name%>
      </td>
      <td>
          <%= c.governorate.governorate_name%>
      </td>
      <td>
          <a href="DeleteHealthCenter.jsp?health_center_id=<%=c.health_center_id%>">حذف</a>
          <a href="UpdateHealthCenter.jsp?health_center_id=<%=c.health_center_id%>">تعديل</a>
      </td>
  </tr>
  <% }%>
                        ...
                        <div class="contact_form_inner" >
                            <fieldset>
                             <div class="field center">
                                 <a href="AddHealthCenter.jsp" class="btn btn-block">إضافة مركز جديد</button>
                                </div>
                            </fieldset>
                        </div>
                    </div>
