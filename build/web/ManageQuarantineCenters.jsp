...
<%
        ...
        */
        ...
        List<QuarantineCenter>quarantines=QuarantineCenterApi.get_all();
...
<body id="home" data-spy="scroll" data-target="#navbar-wd" data-offset="98">
 ...
 <!-- Start Banner -->
  ...
  <% for(QuarantineCenter c : quarantines){%>
  <tr>
      <td> <%= c.quarantine_center_id %></td>
      <td>
          <%= c.quarantine_center_name %>
      </td>
      <td>
          <%= c.governorate.governorate_name%>
      </td>
      <td>
          <a href="DeleteQuarantineCenter.jsp?quarantine_center_id=<%= c.quarantine_center_id %>">حذف</a>
          <a href="UpdateQuarantineCenter.jsp?quarantine_center_id=<%=c.quarantine_center_id %>">تعديل</a>
      </td>
  </tr>
  <% }%>
</table>
                        ...
                        <div class="contact_form_inner" >
                            <fieldset>
                             <div class="field center">
                                 <a href="AddQuarantineCenter.jsp" class="btn btn-block">إضافة مركز جديد</button>
                                </div>
                            </fieldset>
                        </div>
                    </div>
